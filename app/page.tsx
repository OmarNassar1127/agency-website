        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center mb-6 px-3 py-1 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-white/90">Our Impact in Numbers</span>
            </div>
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Our track record speaks for itself. Here's how we've helped businesses transform their digital presence and achieve remarkable growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-6">
            ...
            <div className="flex flex-col items-center p-6 md:p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 transform transition-transform hover:scale-105">
              <div className="text-5xl md:text-6xl font-bold font-display text-white mb-3" style={{ lineHeight: '1' }}>
                97<span className="text-secondary-400">%</span>
              </div>
              <p className="text-lg md:text-xl text-white/70 text-center">Client Satisfaction Rate</p>
            ...
            <div className="flex flex-col items-center p-6 md:p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 transform transition-transform hover:scale-105">
              ...
              <p className="text-lg md:text-xl text-white/70 text-center">Projects Completed</p>
              <div className="mt-4 h-1 w-16 bg-gradient-to-r from-primary-400 to-secondary-400 rounded-full"></div>
            </div>
            ...
            <div className="flex flex-col items-center p-6 md:p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 transform transition-transform hover:scale-105">
              ...
              <p className="text-lg md:text-xl text-white/70 text-center">Average ROI Increase</p>
              <div className="mt-4 h-1 w-16 bg-gradient-to-r from-primary-400 to-secondary-400 rounded-full"></div>
            </div>
            ...
            <div className="flex flex-col items-center p-6 md:p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 transform transition-transform hover:scale-105">
              ...
              <p className="text-lg md:text-xl text-white/70 text-center">Industry Experience</p>
              <div className="mt-4 h-1 w-16 bg-gradient-to-r from-primary-400 to-secondary-400 rounded-full"></div>
            </div>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <div className="text-3xl font-bold text-white font-display">3x Faster</div>
                </div>
              </div>
              <p className="text-white/70">Website and application performance improvement delivered to our clients, leading to higher conversion rates and better user engagement.</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <div className="text-white/70 text-sm mb-1">Cost Reduction</div>
                  <div className="text-3xl font-bold text-white font-display">35%</div>
                </div>
              </div>
              <p className="text-white/70">Average operational cost savings for clients after implementing our custom software solutions and optimizing their digital infrastructure.</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <div className="text-white/70 text-sm mb-1">Time to Market</div>
                  <div className="text-3xl font-bold text-white font-display">40% Less</div>
                </div>
              </div>
              <p className="text-white/70">Reduced development cycle time compared to traditional methodologies, helping our clients gain competitive advantage with faster market entry.</p>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex mx-auto px-6 py-4 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 max-w-3xl">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5 text-yellow-300 mr-3 mt-1 flex-shrink-0">
                <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
              </svg>
              <span className="text-lg text-white italic">
                "Working with Nexus Digital transformed our business completely. The custom software they developed increased our operational efficiency by 45% and helped us scale rapidly."
              </span>
            </div>
            <p className="text-white/70 mt-4">— Michael Chen, CTO at TechCorp</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-block mb-4 px-3 py-1.5 rounded-full bg-primary-50 dark:bg-primary-950/60">
              <span className="text-sm font-medium text-primary-700 dark:text-primary-300">Our Advantage</span>
            </div>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              We combine technical expertise with deep industry knowledge to deliver exceptional software solutions that drive real business value.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-md border border-gray-100 dark:border-gray-800 group hover:border-primary-200 dark:hover:border-primary-800 hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">Seasoned Experts</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Our team of senior developers, designers, and project managers brings an average of 10+ years of experience to every project we undertake.
              </p>
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-md border border-gray-100 dark:border-gray-800 group hover:border-primary-200 dark:hover:border-primary-800 hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white group-hover:text-secondary-600 dark:group-hover:text-secondary-400 transition-colors">Agile Excellence</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Our refined agile methodology ensures transparency, flexibility, and rapid adaptation to changing requirements throughout the development process.
              </p>
              <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-800">
                <ul className="space-y-2">
                  <li className="flex items-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-md border border-gray-100 dark:border-gray-800 group hover:border-primary-200 dark:hover:border-primary-800 hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">Future-Proof Solutions</h3>
              <p className="text-gray-600 dark:text-gray-300">
                We architect scalable solutions using modern tech stacks that grow with your business, avoiding costly rebuilds down the line.
              </p>
              <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-800">
                <ul className="space-y-2">
                  <li className="flex items-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-md border border-gray-100 dark:border-gray-800 group hover:border-primary-200 dark:hover:border-primary-800 hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors">Comprehensive Support</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Our relationship doesn't end at launch. We provide ongoing maintenance, monitoring, and optimization to ensure your software thrives.
              </p>
              <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-800">
                <ul className="space-y-2">
                  <li className="flex items-center text-sm text-gray-600 dark:text-gray-400">
          ...
          {/* CTA button */}
          <div className="mt-16 text-center">
            <Link href="/about" className="btn btn-lg btn-primary inline-flex items-center">
