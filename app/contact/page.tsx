      ...
      <main className="pt-24 pb-20">
        ...
        <section className="relative bg-gradient-to-br from-gray-950 via-primary-900 to-secondary-900 py-24 text-white overflow-hidden">
          ...
          <div className="container relative z-10 mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6">Get in Touch</h1>
            <p className="text-xl text-white/80 max-w-2xl mx-auto mb-8">
              Ready to start your digital transformation? Contact our team to discuss how we can help bring your vision to life.
            </p>
            ...
            <div className="flex flex-wrap gap-4 justify-center mt-8">
              ...
              <Link href="#offices" className="btn btn-lg border-2 border-white/20 text-white hover:bg-white/10">
                Visit Our Office
              </Link>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-12 lg:gap-x-16 items-start">
              ...
              <div className="order-2 lg:order-1 mt-8 lg:mt-0">
                <div className="inline-block mb-6 px-3 py-1.5 rounded-full bg-primary-50 dark:bg-primary-950/60">
                  <span className="text-sm font-medium text-primary-700 dark:text-primary-300">How to Reach Us</span>
                </div>
                
                <h2 className="text-3xl md:text-4xl font-display font-bold mb-6 text-gray-900 dark:text-white">Let's Build Something <span className="gradient-text">Extraordinary</span></h2>
                
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-10 max-w-xl">
                  Whether you have a specific project in mind or just want to explore possibilities, our team is ready to help you navigate the digital landscape and achieve your goals.
                </p>
                ...
                <div className="space-y-8">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Call Us Directly</h3>
                      <p className="text-gray-600 dark:text-gray-300 text-lg mb-1">(555) 123-4567</p>
                      <p className="text-gray-500 dark:text-gray-400">Monday-Friday, 9am-6pm PST</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-lg mb-1">info@nexusdigital.com</p>
                      <p className="text-gray-500 dark:text-gray-400">We respond within 24 hours</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600 dark:text-gray-300 text-lg mb-1">123 Innovation Drive</div>
                      <div className="text-gray-600 dark:text-gray-300 mb-1">San Francisco, CA 94105</div>
                      <Link href="#map" className="flex items-center text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 mt-2 font-medium">
                ...
                <div className="mt-12">
                  ...
                  <div className="flex space-x-4">
                    <a 
                      ...
                      aria-label="Twitter"
                    >
                      <svg className="w-6 h-6 text-gray-700 dark:text-gray-300 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="order-1 lg:order-2 relative">
                ...
                <div className="card card-glass bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-2xl border border-white/10 dark:border-gray-700/80 shadow-highlight p-8 relative">
                  <h3 className="text-2xl font-display font-bold mb-2 text-gray-900 dark:text-white">Start Your Project</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-6">Fill out the form below and we'll get back to you within 24 hours.</p>
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <select 
                        ...
                        required
                      >
                        <option value="" disabled selected>Select the type of project</option>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        <label htmlFor="terms" className="text-gray-600 dark:text-gray-400">
                          I agree to the <a href="/privacy" className="text-primary-600 hover:text-primary-700 dark:text-primary-400">Privacy Policy</a> and <a href="/terms" className="text-primary-600 hover:text-primary-700 dark:text-primary-400">Terms of Service</a>
                        </label>
                      </div>
                    </div>
        ...
        {/* Map Section */}
        <section id="offices" className="py-24 relative bg-gray-50 dark:bg-gray-900">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-12">
                <div className="inline-block mb-4 px-3 py-1.5 rounded-full bg-secondary-50 dark:bg-secondary-950/60">
                  <span className="text-sm font-medium text-secondary-700 dark:text-secondary-300">Our Global Presence</span>
                </div>
                
                <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-gray-900 dark:text-white">Visit Our Offices</h2>
                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  We have offices in strategic locations to better serve our global clients. Feel free to stop by for a coffee and a chat.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                ...
                <div className="overflow-hidden rounded-3xl shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 relative">
                  ...
                  <div className="h-[450px] bg-gradient-to-br from-slate-100 to-gray-100 dark:from-gray-800 dark:to-gray-900 relative">
                    ...
                    <div className="absolute inset-0 overflow-hidden opacity-30">
                      ...
                      <div className="grid grid-cols-6 h-full">
                        {Array.from({ length: 5 }).map((_, i) => (
                          <div key={i} className="border-r border-primary-500/10 h-full"></div>
                        ))}
                      </div>
                      
                      <div className="grid grid-rows-6 w-full">
                        {Array.from({ length: 5 }).map((_, i) => (
                          <div key={i} className="border-b border-primary-500/10 w-full"></div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="absolute top-4 left-6 text-xs text-gray-400 font-mono">San Francisco</div>
                    <div className="absolute bottom-4 right-6 text-xs text-gray-400 font-mono">New York</div>
                    <div className="absolute top-4 right-6 text-xs text-gray-400 font-mono">London</div>
                    <div className="absolute bottom-4 left-6 text-xs text-gray-400 font-mono">Tokyo</div>
                  </div>
                </div>
                
                {/* Office locations cards with hover effect */}
                <div className="space-y-6">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Our Locations</h3>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="flex items-center mb-1">
                          <h4 className="text-lg font-bold text-gray-900 dark:text-white">San Francisco (HQ)</h4>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">123 Innovation Drive, San Francisco, CA 94105</p>
                        ...
                        <div className="mt-3 text-primary-600 dark:text-primary-400 font-medium">
                          <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300">
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-700 hover:border-primary-300 dark:hover:border-primary-700">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-1">New York</h4>
                        <p className="text-gray-600 dark:text-gray-300">456 Tech Square, New York, NY 10001</p>
                        <p className="text-gray-600 dark:text-gray-300 mt-1">+1 (555) 987-6543</p>
                        <div className="mt-3 text-secondary-600 dark:text-secondary-400 font-medium">
                          <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-secondary-600 dark:text-secondary-400 hover:text-secondary-700 dark:hover:text-secondary-300">
                            <span>Get directions</span>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                              <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                            </svg>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-700 hover:border-primary-300 dark:hover:border-primary-700">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-1">London</h4>
                        <p className="text-gray-600 dark:text-gray-300">78 Digital Lane, London, UK EC1A 1AE</p>
                        <p className="text-gray-600 dark:text-gray-300 mt-1">+44 20 1234 5678</p>
                        <div className="mt-3 text-purple-600 dark:text-purple-400 font-medium">
                          <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300">
                            <span>Get directions</span>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                              <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                            </svg>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mb-16">
                <div className="inline-block mb-4 px-3 py-1.5 rounded-full bg-gray-100 dark:bg-gray-800">
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Common Questions</span>
                </div>
                
                <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-gray-900 dark:text-white">Frequently Asked Questions</h2>
                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  Everything you need to know about working with our team and our development process.
                </p>
              </div>
              ...
              <div className="space-y-6">
                  ...
                  <button className="w-full px-8 py-6 text-left focus:outline-none focus:ring-2 focus:ring-primary-500/50 rounded-xl">
                    <div className="flex justify-between items-center">
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                        What information should I provide for a project estimate?
                      </h3>
                    ...
                    <div className="mt-4 text-gray-600 dark:text-gray-300">
                      To provide an accurate estimate, it helps if you can share details about your project goals, desired features, timeline expectations, and budget range. We also appreciate information about your target audience, any existing systems we'll need to integrate with, and design preferences. The more comprehensive your information, the more precise our estimate will be.
                    </div>
                  </button>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-800 overflow-hidden group">
                  <button className="w-full px-8 py-6 text-left focus:outline-none focus:ring-2 focus:ring-primary-500/50 rounded-xl">
                    ...
                    <div className="mt-4 text-gray-600 dark:text-gray-300">
                      Project timelines vary depending on complexity and scope. Simple applications might take 2-3 months, while complex enterprise solutions can take 6+ months. Our agile development process includes planning, design, development, testing, and deployment phases. We'll provide a detailed timeline during our initial consultation and keep you updated with regular progress reports throughout the project.
                    </div>
                  </button>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-800 overflow-hidden group">
                  <button className="w-full px-8 py-6 text-left focus:outline-none focus:ring-2 focus:ring-primary-500/50 rounded-xl">
                    ...
                    <div className="mt-4 text-gray-600 dark:text-gray-300">
                      Yes, we offer flexible maintenance and support plans to ensure your software continues to operate smoothly after launch. Our support packages include bug fixes, security updates, performance optimization, and minor enhancements. We also provide training for your team and documentation to help you maximize the value of your software investment. Many clients choose our monthly retainer options for peace of mind and continuous improvement of their digital products.
                    </div>
                  </button>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-800 overflow-hidden group">
                  <button className="w-full px-8 py-6 text-left focus:outline-none focus:ring-2 focus:ring-primary-500/50 rounded-xl">
                    ...
                    <div className="mt-4 text-gray-600 dark:text-gray-300">
                      We have extensive experience across multiple industries including healthcare, finance, e-commerce, education, manufacturing, and technology. Our team adapts quickly to new domains and industry-specific requirements, bringing our technical expertise and innovative problem-solving approach to every project. Our diverse portfolio allows us to cross-pollinate ideas and solutions between industries, often bringing fresh perspectives to complex challenges.
                    </div>
                  </button>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-800 overflow-hidden group">
                  <button className="w-full px-8 py-6 text-left focus:outline-none focus:ring-2 focus:ring-primary-500/50 rounded-xl">
                    ...
                    <div className="mt-4 text-gray-600 dark:text-gray-300">
                      We stay at the forefront of technology, working with modern stacks including React, Angular, Vue.js, Node.js, Python, .NET, and Java. For mobile development, we're proficient in React Native, Flutter, Swift, and Kotlin. Our cloud expertise spans AWS, Azure, and Google Cloud. While we have our preferred technologies, we're technology-agnostic and focus on selecting the right tools for each specific project's requirements rather than forcing a one-size-fits-all approach.
                    </div>
                  </button>
                </div>
              </div>
              ...
              <div className="mt-16 text-center">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                  ...
                  <a href="tel:+15551234567" className="btn bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700">
