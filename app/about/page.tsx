...
export const metadata = {
  ...
  description: 'Learn about Nexus Digital Agency, our mission, values, and the talented team behind our innovative digital solutions.',
};
      ...
      <div className="pt-24 pb-20">
        ...
        <section className="relative bg-gradient-to-br from-gray-950 via-primary-900 to-secondary-900 py-24 text-white overflow-hidden">
          ...
          <div className="container relative z-10 mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6">
              We Are <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-secondary-400 animate-gradient-x">Nexus Digital</span>
            </h1>
            <p className="text-xl text-white/80 max-w-2xl mx-auto mb-8">
              A collective of digital craftspeople turning innovative ideas into extraordinary digital experiences.
            </p>
              ...
              <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 backdrop-blur p-6 max-w-3xl mx-auto">
                <div className="typing-animation relative pl-4 border-l-2 border-primary-400">
                  <p className="text-md md:text-lg text-left font-mono text-white/90">
                    <span className="text-primary-400">const</span> <span className="text-secondary-400">nexusTeam</span> = [<br/>
                    <span className="ml-4">passion, expertise, innovation, creativity</span><br/>
                    ];<br/><br/>
                    ...
                    <span className="text-primary-400">// Let's build something amazing together</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="mb-16 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold mb-6 text-gray-900 dark:text-white">
                From <span className="gradient-text">Startup to Industry Leader</span>
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                A journey of innovation, growth, and digital excellence that started with a simple idea.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative z-10">
                ...
                <div className="timeline-node mb-20">
                  <div className="flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 mb-6 md:mb-0 md:pr-16 md:text-right order-2 md:order-1">
                      <span className="text-primary-600 dark:text-primary-400 font-bold text-sm uppercase tracking-wider mb-2 block">The Beginning</span>
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">2015 - Nexus Digital Founded</h3>
                      <p className="text-gray-600 dark:text-gray-300">
                        Founded by three college friends with a shared vision to transform how businesses interact with technology. Started in a small apartment with just 3 clients.
                      </p>
                    </div>
                      ...
                      <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700 md:ml-6 transform transition-transform hover:scale-105">
                        <div className="aspect-video bg-gray-200 dark:bg-gray-700 relative">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <p className="text-gray-600 dark:text-gray-400">Founding Team Photo</p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="timeline-node mb-20">
                  <div className="flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 mb-6 md:mb-0 md:pr-16 order-2 md:order-3">
                      <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700 md:mr-6 transform transition-transform hover:scale-105">
                        <div className="aspect-video bg-gray-200 dark:bg-gray-700 relative">
                          {/* Image placeholder */}
                          <div className="absolute inset-0 flex items-center justify-center">
                            <p className="text-gray-600 dark:text-gray-400">First Office Photo</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="md:w-1/2 md:pl-16 mt-6 md:mt-0 md:text-left order-3 md:order-1">
                      <span className="text-secondary-600 dark:text-secondary-400 font-bold text-sm uppercase tracking-wider mb-2 block">Rapid Growth</span>
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">2017 - First Office & Expansion</h3>
                      <p className="text-gray-600 dark:text-gray-300">
                        Moved into our first official office space and expanded to a team of 15. Completed our 50th project and secured our first major enterprise client.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="timeline-node mb-20">
                  <div className="flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 mb-6 md:mb-0 md:pr-16 md:text-right order-2 md:order-1">
                      <span className="text-purple-600 dark:text-purple-400 font-bold text-sm uppercase tracking-wider mb-2 block">Innovation</span>
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">2019 - AI Division Launch</h3>
                      <p className="text-gray-600 dark:text-gray-300">
                        Launched our dedicated AI solutions division, focusing on machine learning and predictive analytics. Won our first industry award for innovation.
                      </p>
                    </div>
                    ...
                    <div className="md:w-1/2 md:pl-16 mt-6 md:mt-0 order-3">
                      <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700 md:ml-6 transform transition-transform hover:scale-105">
                        <div className="aspect-video bg-gray-200 dark:bg-gray-700 relative">
                          {/* Image placeholder */}
                          <div className="absolute inset-0 flex items-center justify-center">
                            <p className="text-gray-600 dark:text-gray-400">AI Team Photo</p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="timeline-node mb-20">
                  <div className="flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 mb-6 md:mb-0 md:pr-16 order-2 md:order-3">
                      <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700 md:mr-6 transform transition-transform hover:scale-105">
                        <div className="aspect-video bg-gray-200 dark:bg-gray-700 relative">
                          {/* Image placeholder */}
                          <div className="absolute inset-0 flex items-center justify-center">
                            <p className="text-gray-600 dark:text-gray-400">Global Team Photo</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="md:w-1/2 md:pl-16 mt-6 md:mt-0 md:text-left order-3 md:order-1">
                      <span className="text-teal-600 dark:text-teal-400 font-bold text-sm uppercase tracking-wider mb-2 block">Global Expansion</span>
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">2021 - International Offices</h3>
                      <p className="text-gray-600 dark:text-gray-300">
                        Expanded to New York, London, and Singapore. Team grew to over 50 professionals across development, design, and marketing disciplines.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="timeline-node">
                  <div className="flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 mb-6 md:mb-0 md:pr-16 md:text-right order-2 md:order-1">
                      <span className="text-rose-600 dark:text-rose-400 font-bold text-sm uppercase tracking-wider mb-2 block">Today & Beyond</span>
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">2023 - Present Day</h3>
                      <p className="text-gray-600 dark:text-gray-300">
                        Today, we're a team of 80+ digital experts working with clients across 15 countries. We've completed over 250 projects and continue to push the boundaries of what's possible in digital.
                      </p>
                    </div>
                    ...
                    <div className="md:w-1/2 md:pl-16 mt-6 md:mt-0 order-3">
                      <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700 md:ml-6 transform transition-transform hover:scale-105">
                        <div className="aspect-video bg-gray-200 dark:bg-gray-700 relative">
                          {/* Image placeholder */}
                          <div className="absolute inset-0 flex items-center justify-center">
                            <p className="text-gray-600 dark:text-gray-400">Current Team Photo</p>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
              <div className="inline-block mb-4 px-3 py-1.5 rounded-full bg-secondary-50 dark:bg-secondary-950/60">
                <span className="text-sm font-medium text-secondary-700 dark:text-secondary-300">What Drives Us</span>
              </div>
              ...
              <div className="value-card group perspective">
                <div className="relative preserve-3d duration-1000 w-full h-[400px]">
                  ...
                  <div className="absolute backface-hidden w-full h-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-8 flex flex-col">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Excellence</h3>
                    <p className="text-gray-600 dark:text-gray-300 mb-6">
                      We strive for excellence in everything we do, from the code we write to the strategies we develop.
                    </p>
                  ...
                  <div className="absolute backface-hidden w-full h-full bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl shadow-xl p-8 flex flex-col rotate-y-180">
                    <h3 className="text-2xl font-bold mb-4 text-white">Excellence in Action</h3>
                    <ul className="text-white/90 space-y-4 mb-6">
                      <li className="flex items-start">
                        <svg className="w-5 h-5 mr-2 text-primary-300 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <li className="flex items-start">
                        ...
                        <span>Never settling for "good enough" when we can make it great</span>
                      </li>
                    </ul>
                    <div className="mt-auto">
              ...
              <div className="value-card group perspective">
                <div className="relative preserve-3d duration-1000 w-full h-[400px]">
                  ...
                  <div className="absolute backface-hidden w-full h-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-8 flex flex-col">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-6">
                      We embrace new technologies and approaches, constantly exploring better ways to solve problems.
                    </p>
                    <div className="mt-auto">
                  ...
                  <div className="absolute backface-hidden w-full h-full bg-gradient-to-br from-secondary-600 to-secondary-800 rounded-2xl shadow-xl p-8 flex flex-col rotate-y-180">
                    <h3 className="text-2xl font-bold mb-4 text-white">Innovation in Action</h3>
                    <ul className="text-white/90 space-y-4 mb-6">
                      <li className="flex items-start">
                        <svg className="w-5 h-5 mr-2 text-secondary-300 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                      ...
                      <li className="flex items-start">
                        ...
                        <span>Regular innovation sprints to generate new ideas</span>
                      </li>
                    </ul>
                    <div className="mt-auto">
                      <div className="text-white/80 italic">
              ...
              <div className="value-card group perspective">
                <div className="relative preserve-3d duration-1000 w-full h-[400px]">
                  ...
                  <div className="absolute backface-hidden w-full h-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-8 flex flex-col">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Collaboration</h3>
                    <p className="text-gray-600 dark:text-gray-300 mb-6">
                  ...
                  <div className="absolute backface-hidden w-full h-full bg-gradient-to-br from-purple-600 to-purple-800 rounded-2xl shadow-xl p-8 flex flex-col rotate-y-180">
                    <h3 className="text-2xl font-bold mb-4 text-white">Collaboration in Action</h3>
                    <ul className="text-white/90 space-y-4 mb-6">
                      <li className="flex items-start">
                        <svg className="w-5 h-5 mr-2 text-purple-300 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span>Cross-functional teams for holistic solutions</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-5 h-5 mr-2 text-purple-300 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      ...
                      <li className="flex items-start">
                        ...
                        <span>Open communication channels across all teams</span>
                      </li>
                    </ul>
                    <div className="mt-auto">
                      <div className="text-white/80 italic">
        ...
        <section className="py-24 bg-white dark:bg-gray-950 overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <div className="inline-block mb-4 px-3 py-1.5 rounded-full bg-primary-50 dark:bg-primary-950/60">
                <span className="text-sm font-medium text-primary-700 dark:text-primary-300">The People Behind Our Success</span>
              </div>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Our diverse team brings together experience from some of the world's most innovative companies.
              </p>
            </div>
            ...
            <div className="relative max-w-4xl mx-auto h-[600px] md:h-[700px]">
              ...
              <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] rounded-full bg-gradient-to-br from-primary-500/20 to-secondary-500/20 backdrop-blur flex items-center justify-center z-10">
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Nexus Team</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">80+ Digital Experts</p>
                </div>
              </div>
              ...
              <div className="team-orbit absolute inset-0">
                ...
                <div className="team-member absolute left-1/2 top-[10%] transform -translate-x-1/2">
                  <div className="relative">
                    ...
                    <div className="mt-3 text-center">
                      <h4 className="font-bold text-gray-900 dark:text-white">James Anderson</h4>
                      <p className="text-primary-600 dark:text-primary-400 text-sm">CEO</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="team-member absolute right-[10%] top-1/3 transform -translate-y-1/2">
                  <div className="relative">
                    ...
                    <div className="mt-3 text-center">
                      ...
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">CTO</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="team-member absolute left-[10%] top-1/3 transform -translate-y-1/2">
                  <div className="relative">
                    ...
                    <div className="mt-3 text-center">
                      ...
                      <p className="text-purple-600 dark:text-purple-400 text-sm">Creative Director</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="team-member absolute left-1/2 bottom-[10%] transform -translate-x-1/2">
                  <div className="relative">
                    ...
                    <div className="mt-3 text-center">
                      <h4 className="font-bold text-gray-900 dark:text-white">Emily Roberts</h4>
                      <p className="text-teal-600 dark:text-teal-400 text-sm">Project Management</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="team-member absolute right-[20%] bottom-[25%]">
                  <div className="relative">
                    ...
                    <div className="mt-3 text-center">
                      ...
                      <p className="text-rose-600 dark:text-rose-400 text-sm">AI Director</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="team-member absolute left-[20%] bottom-[25%]">
                  <div className="relative">
                    ...
                    <div className="mt-3 text-center">
                      ...
                      <p className="text-amber-600 dark:text-amber-400 text-sm">Marketing Lead</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              ...
              <div className="counter-item">
                <div className="text-5xl md:text-6xl font-bold font-display text-white mb-2">
                  <span className="counter-value" data-target="250">250</span><span className="text-secondary-400">+</span>
                </div>
              ...
              <div className="counter-item">
                <div className="text-5xl md:text-6xl font-bold font-display text-white mb-2">
                  <span className="counter-value" data-target="80">80</span><span className="text-secondary-400">+</span>
                </div>
              ...
              <div className="counter-item">
                <div className="text-5xl md:text-6xl font-bold font-display text-white mb-2">
                  <span className="counter-value" data-target="8">8</span>
                </div>
        ...
        <section className="py-24 bg-white dark:bg-gray-950 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900 dark:text-white">Ready to Work With Us?</h2>
              ...
              <div className="bg-gradient-to-r from-primary-600 to-secondary-600 p-1 rounded-xl shadow-xl">
                <div className="bg-white dark:bg-gray-900 rounded-lg p-8 md:p-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="text-left">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Start a Conversation</h3>
                    <p className="text-gray-600 dark:text-gray-300 mb-6">
                      Share your project ideas with us, and let's explore how we can bring them to life.
                    </p>
                    <Link href="/contact" className="btn-lg btn-primary inline-flex items-center">
                  ...
                  <div className="text-center md:text-right">
                    <span className="inline-block text-5xl font-display font-bold gradient-text mb-4">Let's Create</span>
                    <p className="text-gray-600 dark:text-gray-300">
